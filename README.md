...
1. Agregar las siguientes dependencias en el build.gradle del proyecto:
...
2. Agregar en el Manigest.xml lo siguiente en la sección application (el id de ads proporcionado es de 
